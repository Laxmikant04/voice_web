      ...
      Object(_sentry_core__WEBPACK_IMPORTED_MODULE_1__["withScope"])(function (scope) {
        scope.addEventProcessor(function (event) {
          ...
          processedEvent.extra = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, processedEvent.extra, {
            arguments: Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_2__["normalize"])(args, 3)
          });
...
function () {
  ...
  Breadcrumbs.prototype._instrumentDOM = function () {
    ...
    global.document.addEventListener('keypress', Object(_helpers__WEBPACK_IMPORTED_MODULE_4__["keypressEventHandler"])(), false); // After hooking into document bubbled up click and keypresses events, we also hook into user handled click & keypresses.
  ...
  Breadcrumbs.prototype._instrumentHistory = function () {
    ...
    var captureUrlChange = function captureUrlChange(from, to) {
      ...
      var parsedFrom = Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_3__["parseUrl"])(from); // Initial pushState doesn't provide `from` information
...
function wrap(fn) {
  ...
  Object(_helpers__WEBPACK_IMPORTED_MODULE_3__["wrap"])(fn)();
}
...
TraceKit._report = function reportModuleWrapper() {
  ...
  function _traceKitWindowOnError(message, url, lineNo, columnNo, errorObj) {
    ...
    errorObj = Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_1__["isErrorEvent"])(errorObj) ? errorObj.error : errorObj; // If 'message' is ErrorEvent, get real message from inside
    ...
    if (lastExceptionStack) {
      ...
      stack = {
        ...
        mode: 'onerror',
        mechanism: 'onerror',
        stack: [tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, location, {
...
function () {
  ...
  Scope.prototype.addBreadcrumb = function (breadcrumb, maxBreadcrumbs) {
    ...
    this._breadcrumbs = maxBreadcrumbs !== undefined && maxBreadcrumbs >= 0 ? tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this._breadcrumbs, [Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_1__["normalize"])(mergedBreadcrumb)]).slice(-maxBreadcrumbs) : tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this._breadcrumbs, [Object(_sentry_utils__WEBPACK_IMPORTED_MODULE_1__["normalize"])(mergedBreadcrumb)]);
...
function walk(key, value, depth, memo) {
  ...
  var source = Object(_is__WEBPACK_IMPORTED_MODULE_0__["isError"])(value) ? objectifyError(value) : value; // Create an accumulator that will act as a parent for all future itterations of that branch
