...
/***/ "../node_modules/react-router-navigation-prompt/es/index.js":
/*!******************************************************************!*\
  !*** ../node_modules/react-router-navigation-prompt/es/index.js ***!
  \******************************************************************/
...
function (module, exports, __webpack_require__) {
  ...
  var NavigationPrompt = function (_React$Component) {
    ...
    function NavigationPrompt(props) {
      ...
      _this._prevUserAction = ''; // This component could be used from inside a page, and therefore could be
      ...
      _this.state = _extends({}, initState, {
        ...
        /* unblock will be set in componentDidMount */
